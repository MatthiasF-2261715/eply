    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">Je moet ingelogd zijn om het dashboard te bekijken.</p>
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-xl text-gray-600">
                Hallo {user?.displayName || 'Gebruiker'}! Hier komen later je e-mails en draft-functies.
              </p>
            </div>
            <Button
              onClick={signOut}
